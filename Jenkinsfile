        ...
        stage('Upload Test Results to Artifactory') {
            steps {
                script {
                    ...
                    sh "jf rt upload --url http://172.17.208.1:8082/artifactory/ --access-token ${env.ARTIFACTORY_ACCESS_TOKEN} /var/lib/jenkins/workspace/junittesting/target/surefire-reports/TEST-calculatorTest.xml jt-junit/"
